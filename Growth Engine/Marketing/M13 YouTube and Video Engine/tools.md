...
| Analytics | **M13-native analytics** (built into the platform, free) + **Looker Studio** for cross-platform rollups | Feeds M21 |

## Platform-specific tools

- **YouTube Studio** — free, first-party; required for the SEO fields (title, description, 10 tags, thumbnail) called out in README.md §2.
- **TubeBuddy or vidIQ free tier** — for keyword research on titles/tags (verify current free-tier limits).
- Screen-recording: any free screen recorder (e.g. OBS Studio, OSS) for the walkthrough format in the content mix.
