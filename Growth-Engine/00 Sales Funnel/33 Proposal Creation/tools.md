...
|---|---|---|---|---|
| PandaDoc / Proposify | Proposal creation + e-signature, professional look | Paid, verify current tier pricing | Documenso (OSS e-signature) | API |
...
| DocuSign / Signable | E-signature and contract execution (Stage 36 handoff) | Usage-based / subscription | Documenso (OSS e-signature) | API |
