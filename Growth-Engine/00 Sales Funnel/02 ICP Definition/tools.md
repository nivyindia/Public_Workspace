...
| Google Sheets / Notion | ICP card drafting & storage | Free | NocoDB / Baserow (self-hosted airtable-style DB) | Notion API for automation | Low |
| SurveyMonkey / Typeform | Buyer interview follow-up surveys | Free tier + paid | Google Forms | API on paid tiers | Low |
| Claude / ChatGPT (web-enabled) | AI-assisted ICP synthesis and stress-testing | Subscription, ~$20/mo | Ollama / Open WebUI (self-hosted LLM — avoids sending data to a paid API) | API available | Low |
