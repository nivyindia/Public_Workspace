...
| GPT-4o class LLM | Churn-risk prediction from CSAT/engagement/delivery data | Usage-based | Ollama / Open WebUI (self-hosted LLM — avoids sending data to a paid API) | API |
