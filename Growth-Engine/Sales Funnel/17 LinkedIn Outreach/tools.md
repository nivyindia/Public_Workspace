...
- Any browser-automation tool carries account-restriction risk if daily limits are exceeded — always err conservative over the published limit, not up to it.
